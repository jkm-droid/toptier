...
//        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Past Matches");
    ...
    class Adapter extends ArrayAdapter {
        public Adapter(@NonNull Context context, @NonNull List objects){
            super(context, R.layout.past_matches, objects);
        }
        @NonNull
        @Override
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
            View v;
            if (convertView == null)
                v = LayoutInflater.from(getContext()).inflate(R.layout.past_matches, null);
            else v = convertView;
